...
pub mod pallet {
	...
	impl<A: Decode> Default for AllychainBondConfig<A> {
	...
	pub enum Event<T: Config> {
		...
		/// Account (re)set for allychain bond treasury.
		AllychainBondAccountSet {
			old: T::AccountId,
			new: T::AccountId,
		},
		/// Percent of inflation reserved for allychain bond (re)set.
		AllychainBondReservePercentSet { old: Percent, new: Percent },
