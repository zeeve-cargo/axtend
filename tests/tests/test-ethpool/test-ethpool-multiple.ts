...
/*
  ...
  */
describeDevAxtendAllEthTxTypes("EthPool - Multiple pending transactions", (context) => {
  let txHashes: string[];
...
describeDevAxtendAllEthTxTypes("EthPool - Multiple produced transactions", (context) => {
  let txHashes: string[];
